        ...
        <form action="" method="post">
            ...
            <div className="w-full">
                ...
                <div className="flex items-center gap-5 mt-5">
                    <Button onClick={() => navigate('/coupons/eligible-user')}>User</Button>
                ...
                <div className="pt-6 flex flex-col gap-3 w-3/4">
                    <h2 className="font-bold text-lg pb-3">Select Applicable Products</h2>
                    <div className="flex justify-between items-center w-[80%] border border-neutral-400 p-4 rounded-md">
                        <h3>Choose</h3>
                        <CustomPopover icon={<PlusIcon className="bg-blue-900 text-white rounded-sm cursor-pointer" />}>
                            <Button size="sm" variant="" className="justify-start px-2 py-1 rounded-md">All Products</Button>
                            <Button size="sm" variant="ghost" className="justify-start px-2 py-1 rounded-md">Select Product</Button>
                        </CustomPopover>
                    </div>

                </div>
                <div className="flex items-center gap-10 py-16 w-96">
