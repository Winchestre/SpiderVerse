                    ...
                    <div key={index}>
                        <div className="flex justify-between">
                            <div className="flex-col justify-start items-start flex w-full">
                                <p className="text-neutral-400 text-sm leading-tight mb-1">Amount Limit</p>
                                <div className="text-base font-semibold pb-2 w-full">${user.limitPerDay}</div>
                                <hr 
                                    style={{
                                        width: '95%',
                                    }}
                            ...
                            <div className="flex-col justify-start items-start flex w-full">
                                <p className="text-neutral-400 text-sm leading-tight mb-1">Amount Limit</p>
                                <div className="text-base font-semibold pb-2 w-full">${user.limitPerMonth}</div>
                                <hr
                                    style={{
                                        width: '95%',
                                    }}
